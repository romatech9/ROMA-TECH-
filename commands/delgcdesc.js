// ============================================================
// MUFASER-X — DELETE GROUP DESCRIPTION
// ============================================================
  ...
  async execute(
    ...
    try {
      ...
      if (!isBotAdmin) {
        ...
        return await sock.sendMessage(
          ...
          {
            text:
              '❌ *I need to be a group admin to delete the group description.*'
          },
          {
            quoted: msg
          }
    ...
    const senderMention =
      ...
      return await sock.sendMessage(
        jid,
        {
          text:
            ...
            `🗑️ The group description has been cleared.`,
      ...
      return await sock.sendMessage(
        ...
        {
          text:
            '❌ *Failed to delete group description.*\n\n' +
            `⚠️ *Reason:* ${
              error?.message ||
