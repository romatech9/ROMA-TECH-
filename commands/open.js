// ============================================================
// MUFASER-X — OPEN / UNMUTE GROUP
// ============================================================

module.exports = {
  name: 'open',
  aliases: ['unmute', 'unlock', 'gcopen'],
  ...
  async execute(sock, msg, jid, args, sender, account) {
    ...
    try {
      ...
      if (!isBotAdmin) {
        return await sock.sendMessage(jid, { text: '❌ *I need to be a group admin to open the group.*' }, { quoted: msg });
      }
      ...
      return await sock.sendMessage(jid, { text: `❌ *Failed to open the group.*\n\n⚠️ *Reason:* ${error?.message || 'Unknown error'}` }, { quoted: msg });
    }
  }
};